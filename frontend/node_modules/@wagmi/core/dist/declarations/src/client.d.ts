...
import { Connector, ConnectorData } from '@wagmi/core/dist/declarations/src/connectors';
import { ClientStorage } from '@wagmi/core/dist/declarations/src/storage';
import { Provider, WebSocketProvider } from '@wagmi/core/dist/declarations/src/types';
...
export declare class Client<TProvider extends Provider = Provider, TWebSocketProvider extends WebSocketProvider = WebSocketProvider> {
    ...
    get chains(): import("@wagmi/core/dist/declarations/src/types").Chain[] | undefined;
