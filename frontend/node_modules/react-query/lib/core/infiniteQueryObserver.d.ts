import type { DefaultedInfiniteQueryObserverOptions, FetchNextPageOptions, FetchPreviousPageOptions, InfiniteData, InfiniteQueryObserverOptions, InfiniteQueryObserverResult, QueryKey } from 'react-query/lib/core/types';
import type { QueryClient } from 'react-query/lib/core/queryClient';
import { NotifyOptions, ObserverFetchOptions, QueryObserver } from 'react-query/lib/core/queryObserver';
